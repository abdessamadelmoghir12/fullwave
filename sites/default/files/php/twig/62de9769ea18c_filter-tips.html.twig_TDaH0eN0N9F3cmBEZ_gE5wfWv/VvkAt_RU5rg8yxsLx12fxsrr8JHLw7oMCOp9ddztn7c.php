...
class __TwigTemplate_ae932f766a0270d0cf78bfb373a4dffddca84b11429e8e00af6bdd7898fcbb0b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/bartik/templates/classy/content-edit/filter-tips.html.twig", "C:\\wamp64\\www\\fullwave\\core\\themes\\bartik\\templates\\classy\\content-edit\\filter-tips.html.twig");
    }
